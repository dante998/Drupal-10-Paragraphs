...
class __TwigTemplate_01af903290ff251b4ea16c944da13c67 extends Template
{
    private $source;
    private $macros = [];
...
($context["align"] ?? null) == "left")) ? ("float-start") : ("")), 2 => (((        // line 15
($context["align"] ?? null) == "right")) ? ("float-end") : ("")), 3 => (((        // line 16
...
{% set classes = [
  ...
  align == 'left' ? 'float-start',
  align == 'right' ? 'float-end',
  align == 'center' ? 'mx-auto d-block',
]|merge(utility_classes ? utility_classes : []) %}

<img{{ attributes.addClass(classes) }} />
", "@radix/image/image.twig", "themes/contrib/radix/src/components/image/image.twig");
    }
